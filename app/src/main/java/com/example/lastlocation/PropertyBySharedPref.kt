...
class PropertyBySharedPref <T>(private val keyName: String = "", private val default: T) :ReadWriteProperty<Any,T>{

    companion object {
        val spName: String = "location_sp"
        private val sharedPreferences: SharedPreferences =
            MyappLication.appContext!!.getSharedPreferences(spName, Context.MODE_PRIVATE)
