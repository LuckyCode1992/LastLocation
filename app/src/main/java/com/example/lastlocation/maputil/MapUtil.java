package com.example.lastlocation.maputil;
...
public class MapUtil {
    ...
    public void myLocation2WhereByGaode(float lat, float lon) {
        ...
        try {
            Intent intent = Intent.getIntent("androidamap://route?sourceApplication=softname&sname=我的位置&dlat=" + lat + "&dlon=" + lon + "&dname=我的目的地" + "" + "&dev=0&m=0&t=0");
    ...
    public void myLocation2WhereByGaode(float lat, float lon, String whereName) {
        ...
        try {
            Intent intent = Intent.getIntent("androidamap://route?sourceApplication=softname&sname=我的位置&dlat=" + lat + "&dlon=" + lon + "&dname=" + whereName + "&dev=0&m=0&t=0");
            context0.startActivity(intent);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void from2WhereByGaode(float fromlat, float fromlon, float lat, float lon) {
        try {
            Intent intent = Intent.getIntent("androidamap://route?sourceApplication=softname&slat=" + fromlat + "&slon=" + fromlon + "&sname=" + "我的位置" + "&dlat=" + lat + "&dlon=" + lon + "&dname=" + "我的目的地" + "&dev=0&m=0&t=0");
            context0.startActivity(intent);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                    "116.247282" +
    ...
    public boolean isOpenGps() {
        LocationManager locationManager
                = (LocationManager) context0.getSystemService(Context.LOCATION_SERVICE);
